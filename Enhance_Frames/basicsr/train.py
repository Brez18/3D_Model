...
from Enhance_Frames.basicsr.data import create_dataloader, create_dataset
from Enhance_Frames.basicsr.data.data_sampler import EnlargedSampler
from Enhance_Frames.basicsr.data.prefetch_dataloader import CPUPrefetcher, CUDAPrefetcher
from Enhance_Frames.basicsr.models import create_model
from Enhance_Frames.basicsr.utils import (MessageLogger, check_resume, get_env_info,
                           get_root_logger, get_time_str, init_tb_logger,
                           init_wandb_logger, make_exp_dirs, mkdir_and_rename,
                           set_random_seed)
from Enhance_Frames.basicsr.utils.dist_util import get_dist_info, init_dist
from Enhance_Frames.basicsr.utils.options import dict2str, parse
...
def parse_options(is_train=True):
    ...
    args.opt = "options/test/REDS/NAFNet-width64.yml"
